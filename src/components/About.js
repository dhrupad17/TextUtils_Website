...
export default function About(props) {
    ...
    return (
        <div className="container">
            <h1 className="my-3" style={{color: props.mode ==='dark'?'#fff':'#042743'}}>About Us</h1>
            <div className="accordion" id="accordionExample">
                ...
                <div className="accordion-item">
                    ...
                    <div className="accordion-body" style={myStyle}>
                    TextUtils is a free character counter tool that provides instant character count & word count statistics for a given text. TextUtils reports the number of words and characters. Thus it is suitable for writing text with word/ character limit. Moreover it has two different themes light and dark to make it user friendly and good looking website.
                    </div>
                    </div>
                </div>
                <div className="accordion-item">
